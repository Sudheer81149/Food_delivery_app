...
import com.devdroid.wavesoffood.databinding.MenuItemBinding

class MenuAdapter(private val MenuItems:MutableList<String>,private val MenuItemPrice:MutableList<String>,private val MenuImage:MutableList<Int>,private val requiredContex:Context): RecyclerView.Adapter<MenuAdapter.MenuViewHolder>() {
